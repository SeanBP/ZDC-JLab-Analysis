...
// --
void gen_particles(
                    int n_events = 6500000, 
                    const char* out_fname = "e_5.3GeV.hepmc", 
                    TString particle_name = "e+",
                    double th_min = -4, // Minimum polar angle, in degrees
		    double th_max = -4, // Maximum polar angle, in degrees
		    double phi_min =  -30.0, // Minimum azimuthal angle, in degrees
                    double phi_max = -30.0, // Maximum azimuthal angle, in degrees
                    double p = 5.3,  // Momentum in GeV/c
